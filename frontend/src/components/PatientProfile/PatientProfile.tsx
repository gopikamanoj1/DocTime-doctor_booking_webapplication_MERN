...
const PatientProfile: React.FC = () => {
      ...
      isGenderValid
        ...
        try {
            ...
            const response = await axios
              ...
              .post("http://localhost:3000/api/auth/updatePatientProfile", data);
  ...
  useEffect(() => {
    ...
    const firstAddress = patientProfileData.data.address && patientProfileData.data.address.length > 0 ? patientProfileData.data.address[0] : {};
