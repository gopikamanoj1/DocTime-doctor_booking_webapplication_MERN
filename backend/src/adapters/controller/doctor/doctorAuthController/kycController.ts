...
//             const certificateImageUrl = await uploadToS3(certificateImage, `${email}-certificate`);
//             const qualificationImageUrl = await uploadToS3(qualificationImage, `${email}-qualification`);

//             const data = {
//                 kycDetails: [{
//                     certificateImage: { url: certificateImageUrl },
//                     qualificationImage: { url: qualificationImageUrl },
//                     aadhaarNumber,
//                     yearsOfExperience,
//                     hospitalName
//                 }],
