...
exports.default = (dependecies) => {
    ...
    const getConvetsationIdForVideoCallController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { userId, doctorId } = req.body;
            const data = {
                userId, doctorId
            };
            const response = yield getConvetsationIdForVideoCallUseCase(dependecies).executeFunction(data);
