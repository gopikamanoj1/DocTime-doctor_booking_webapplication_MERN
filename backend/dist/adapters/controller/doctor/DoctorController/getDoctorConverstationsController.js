...
exports.default = (dependecies) => {
    ...
    const getDoctorConverstationsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.query;
            const data = {
                id
            ...
            const response = yield getDoctorConverstationsUseCase(dependecies).executeFunction(data);
