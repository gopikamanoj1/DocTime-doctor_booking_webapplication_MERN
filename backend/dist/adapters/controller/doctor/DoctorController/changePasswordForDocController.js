...
exports.default = (dependencies) => {
    ...
    const changePasswordForDocController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield changePasswordForDocUseCase(dependencies).executeFunction(data);
