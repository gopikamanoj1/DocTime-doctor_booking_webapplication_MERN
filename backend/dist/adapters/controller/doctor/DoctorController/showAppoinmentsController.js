...
exports.default = (dependecies) => {
    ...
    const showAppoinmentsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { doctorId } = req.body;
            const data = {
                doctorId
            };
            const response = yield showAppoinmentsUseCase(dependecies).executeFunction(data);
