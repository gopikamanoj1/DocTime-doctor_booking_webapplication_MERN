...
exports.default = (dependecies) => {
    ...
    const getAlreadyScheduledSlotesController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { doctorId } = req.body;
            const data = {
                doctorId
            };
            const response = yield getAlreadyScheduledSlotesUseCase(dependecies).executeFunction(data);
