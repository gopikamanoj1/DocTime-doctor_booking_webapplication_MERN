...
exports.default = (dependecies) => {
    ...
    const getAppoinmentDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.body;
            const data = {
                id
            };
            const response = yield getAppoinmentDetailsUseCase(dependecies).executeFunction(data);
