...
exports.default = (dependencies) => {
    ...
    const handleDoctorBlockController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { doctorId } = req.params;
            const response = yield handleDoctorBlockUseCase(dependencies).executeFunction(doctorId);
