...
exports.default = (dependecies) => {
    ...
    const getAvailableSlotController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const response = yield getAvailableSlotUseCase(dependecies).executeFunction(id);
