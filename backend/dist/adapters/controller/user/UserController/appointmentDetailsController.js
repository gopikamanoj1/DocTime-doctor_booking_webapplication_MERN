...
exports.default = (dependecies) => {
    ...
    const appointmentDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { userId } = req.body;
            const data = {
                userId
            };
            const response = yield appointmentDetailsUseCase(dependecies).executeFunction(data);
