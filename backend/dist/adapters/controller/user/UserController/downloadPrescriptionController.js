...
exports.default = (dependecies) => {
    ...
    const downloadPrescriptionController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { appoinmentId } = req.body;
            const data = {
                appoinmentId
            };
            const response = yield downloadPrescriptionUseCase(dependecies).executeFunction(data);
