...
function updateDoctorProfileUseCase(dependencies) {
    const { doctorRepositery } = dependencies.repositery;
    const executeFunction = (data) => __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield doctorRepositery.updateDoctorProfile(data);
            if (response.status) {
...
exports.default = updateDoctorProfileUseCase;
