...
function downloadPrescriptionUseCase(dependencies) {
    const { userRepositery } = dependencies.repositery;
    const executeFunction = (data) => __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield userRepositery.downloadPrescription(data);
            if (response.status) {
...
exports.default = downloadPrescriptionUseCase;
